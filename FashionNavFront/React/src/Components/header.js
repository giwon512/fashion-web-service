...
const Header = () => {
    ...
    const [isSearchOpen, setIsSearchOpen] = useState(false); // 검색 창 상태
    ...
    // 로그인 상태에 따라 메뉴 텍스트 결정
    const renderRightMenu = () => {
        if (isLoggedIn) {
            return (
                <>
                    <span className='LOGOUT' onClick={() => setIsLoggedIn(false)}>LOGOUT</span>
                    <span className='MYPAGE'><Link to="/mypage">MYPAGE</Link></span>
                </>
            );
        } else {
            return (
                <>
                    ...
                    <span className='JOIN'><Link to="/signup">SIGN UP</Link></span>
                </>
            );
        }
    };
        ...
        <header className='header'>
            <div className='header_topbar'>
                <div className='header_top'>
                    <span className='header_top_txt'>Discover the Latest Trends in Fashion</span>
                </div>
            </div>
            ...
            <div className='header_menu'>
                ...
                <div className='header_rightmenu'>
                    {renderRightMenu()}
                    <div className='_icon' onClick={toggleSearch}>
                        <img src="../../public/search_icon.png"></img>
                    </div>
                    {isSearchOpen && (
