import requests
from database import News, insert_data, dbconnect, insert_image, search_data
...
def scrape_news():
    ...
    for i in range(1, 2):
        ...
        for news in news_list:
            ...
            img_src = "https://www.fashionn.com" + news.img["src"]
            # print(title) # 제목
            # print(link) # 링크
            # print(desc) # 부제목
...
def save_image():
    conn = dbconnect()
    results = search_data(conn)
    # for result in results:
    #     print(result)
    imgData = base64.b64decode(results[0][0])
